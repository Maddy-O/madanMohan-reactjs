...
export const POST_NEW_PRODUCT_FAILURE = "POST_NEW_PRODUCT_FAILURE";

//-----------------Delete Product From Redux Only--------------------------
export const DELETE_PRODUCT_REDUX_REQUEST = "DELETE_PRODUCT_REDUX_REQUEST";
export const DELETE_PRODUCT_REDUX_SUCCESS = "DELETE_PRODUCT_REDUX_SUCCESS";
export const DELETE_PRODUCT_REDUX_FAILURE = "DELETE_PRODUCT_REDUX_FAILURE";
